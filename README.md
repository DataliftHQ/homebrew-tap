...
While you may search across taps, it is necessary to always use fully qualified name (incl. the `datalifthq/tap/` prefix) when refering to formulae in external taps such as this one outside of search.
